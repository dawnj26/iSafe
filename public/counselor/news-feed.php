  ...
  <div class="grid grid-cols-[12rem_1fr] max-h-full h-full">
        ...
        <li class="w-full">
          <a href="news-feed.php">
            ...
            <div class="p-4 active-tab text-brand-600 w-full f-full border-r-4 border-brand-600 hover:bg-slate-100 cursor-pointer flex items-center gap-2">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3Z" stroke="#7F56D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M10 7H7V16H10V7Z" stroke="#7F56D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M17 7H14V12H17V7Z" stroke="#7F56D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
    ...
    <div class="bg-gray-100 h-full max-h-full w-full p-2 relative">
      <div class="h-[35.3rem] w-full bg-white rounded-lg p-4 overflow-y-scroll grid grid-cols-[45rem_1fr] gap-2 relative">
        <div class="post place-self-center m-auto" id="posts">
        </div>
        <!--Quote-->
      ...
      <button id="new-post-btn" type="button" class="flex items-center gap-4 px-4 py-2 bg-brand-600 text-white rounded-lg font-medium absolute bottom-16 right-36 hover:bg-brand-700">
        New post
...
?>
  ...
  <!--Create new post-->
  <div id="new-post-modal" class="w-full h-full bg-brand-400 bg-opacity-40 hidden place-items-center absolute">
    <div class="bg-white p-8 w-3/6 rounded-xl">
      <form id="create-post-form">

          <input type="hidden" name="poster_id" id="poster_id" value="<?php echo $current_id ?>">
        <div class="header flex justify-between mb-6">
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="profile flex items-center gap-2">
            ...
            <div class="profile-details">
              <p class="text-sm font-medium"><?php echo $fullname ?></p>
              <p class="text-sm text-gray-500 capitalize"><?php echo $role ?></p>
            </div>
          </div>
          <label for="anonymous-post" class="flex items-center cursor-pointer">
            <!-- toggle -->
            <div class="relative">
              <!-- input -->
              <input name='anonymous-post' id="anonymous-post" type="checkbox" class="sr-only" />
              <!-- line -->
        ...
        <div class="flex flex-col">
          <textarea name="post-text" id="post-text" cols="30" rows="4" placeholder="What's on your mind?" class="placeholder:text-xl outline-none py-2 resize-none rounded-lg"></textarea>
        </div>

        <!-- component -->
        <div class="flex w-full items-center justify-center bg-grey-lighter">
          <label class="w-full flex flex-col items-center px-2 py-4 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-blue-500 mb-4">
        ...
        <button type="submit" class="bg-brand-600 text-white font-medium py-2 px-4 rounded-lg w-full hover:bg-brand-700">Post</button>
      </form>
