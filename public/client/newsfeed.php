...
<body class="h-screen flex flex-col font-inter relative">
    <header class="py-4 px-6 flex w-full items-center justify-between shadow">
        ...
        <div class="flex items-center gap-10">
            ...
            <button type="button" class="font-inter text-xs bg-brand-600 text-white font-semibold flex gap-2 items-center py-2 px-4 rounded-lg hover:bg-brand-700 h-min">
    ...
    <div class="grid grid-cols-[12rem_1fr] h-full">
            ...
            <ul>
                <li class="flex items-center p-4 gap-2 w-full hover:bg-slate-100 cursor-pointer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                        <path d="M9 22V12H15V22M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    Dashboard
                </li>
                ...
                <li class="flex items-center p-4 gap-2 active-tab text-brand-600 w-full border-r-4 border-brand-600 hover:bg-slate-100 cursor-pointer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-brand-600">
        ...
        <div class="bg-gray-100 p-4 relative flex flex-col min-h-screen">
            <div class="grid grid-cols-2 gap-8" id="postContainer">
                <!-- Left Container - Post 1 -->
                <div class="col-span-1 overflow-y-auto">
                    <div class="bg-white p-4 relative post-container mb-4 mr-3 rounded-lg">
                        <!-- X icon -->
                        ...
                        <div class="flex items-center mb-4">
                            <img src="image/Avatar.svg" alt="Profile Picture" class="w-16 h-16 rounded-full mr-4">
                            <div>
                                <p class="font-bold text-sm">Juan Dela Cruz</p>
                                <p class="text-gray-500 text-xs">Student &bull; December 25, 2023</p>
                            </div>
                        </div>

                        <!-- Caption Section - Post 1 -->
                        <p class="mb-4 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla a pretium ex. Nullam dui justo, posuere sed finibus et, fringilla nec urna. Mauris lacinia metus sit amet ligula commodo scelerisque.</p>

                        <!-- Photo Section - Post 1 -->
                        <img src="image/placeholder.svg" alt="Uploaded Photo" class="w-full mb-4">

                        <hr class="my-8 border-t border-gray-400">

                        <div class="mt-4 p-2 flex justify-center" style="gap: 200px;">
                            <div class="flex items-center">
                                <div class="p-2">
                                    <img src="image/like.svg" alt="Like Icon" class="w-full mb-1">
                                </div>
                                <span class="mr-2">Like</span>
                            </div>
                            <div class="flex items-center">
                                <div class="p-2">
                                    <img src="image/comment.svg" alt="Comment Icon" class="w-full mb-1">
                                </div>
                                <span>Comment</span>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-4 relative post-container mb-4 mr-3 rounded-lg">
                        ...
                        <img src="image/x_icon.svg" alt="Close Icon" style="position: absolute; top: 8px; right: 8px; cursor: pointer; width: 24px; height: 24px; z-index: 1;">
                        <div class="flex items-center mb-4">
                            <img src="image/anonymous.svg" alt="Anonymous Profile Picture" class="w-16 h-16 rounded-full mr-4">
                            <div>
                                <p class="font-bold text-sm">Anonymous</p>
                                <p class="text-gray-500 text-xs">Anonymous &bull; December 26, 2023</p>
                            </div>
                        </div>

                        <!-- Caption Section - Post 2 (Anonymous) -->
                        <p class="mb-4 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla a pretium ex. Nullam dui justo, posuere sed finibus et, fringilla nec urna. Mauris lacinia metus sit amet ligula commodo scelerisque.</p>

                        <!-- Photo Section - Post 2 (Anonymous) -->
                        <img src="image/placeholder.svg" alt="Uploaded Photo" class="w-full mb-4">
                ...
                <div class="col-span-2 flex flex-col">
                    <div class="bg-white p-4 max-w-xs rounded-lg" style="position: fixed; width: 580px;">
                        <div class="mb-4">
                            <img src="image/placeholder2.svg" alt="Right Container Photo" class="w-full">
                        </div>
                        <div class="text-center">
                            <p class="italic text-xs text-gray-500 mb-2">Quote of the day</p>
                            <blockquote class="text-sm">
                                <p class="mb-2 font-semibold">"Darkness cannot drive out darkness: only light can do that. Hate cannot drive out hate: only love can do that."</p>
                                <p class="text-right text-xs">- Martin Luther King Jr.</p>
                            </blockquote>
                        </div>
                    </div>
                    <!-- New post button -->
                    <button type="button" class="fixed bg-brand-600 text-white flex gap-2 items-center py-2 px-4 rounded-lg hover:bg-brand-700" style="bottom: 2rem; right: 4rem;">
                        <img src="image/add_icon.svg" alt="Add Icon" class="w-12 h-12">
                        New Post
                    </button>
                </div>
            </div>
