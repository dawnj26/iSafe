                ...
                <form action="#" method="post">
                    ...
                    <div class="remember-forgot-container flex justify-between items-center mb-4">
                        ...
                        <div class="form-group forgot-password text-right">
                            <a href="#" class="text-blue-500" style="color: #7F56D9;">Forgot Password?</a>
                        </div>
                    </div>
                      <br>
                    <button type="submit" class="login-button text-white px-4 py-2 w-full rounded hover:bg-green-500 transition duration-300" style="background-color: #7F56D9;">Log in</button>
                </form>
                <br>
